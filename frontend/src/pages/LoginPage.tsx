...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col md:flex-row overflow-hidden font-sans text-white bg-slate-950 select-none">
      
      {/* LEFT HALF (60%): Full-bleed dam image with details & map */}
      <div 
        className="relative w-full md:w-3/5 lg:w-[58%] h-1/2 md:h-full flex flex-col justify-between p-8 md:p-12 overflow-hidden shrink-0"
        style={{
      ...
      >
        ...
        <div className="relative z-20 my-auto space-y-6">
          ...
          <div className="grid grid-cols-12 gap-6 items-center">
            ...
            <div className="col-span-12 md:col-span-5 space-y-4">
              {/* Feature 1 */}
              <div className="bg-slate-950/40 border border-slate-800/60 backdrop-blur-md rounded-2xl p-4 flex gap-4 items-start transition-all hover:border-slate-700/50 hover:bg-slate-955/60">
              ...
              {/* Feature 2 */}
              <div className="bg-slate-955/40 border border-slate-800/60 backdrop-blur-md rounded-2xl p-4 flex gap-4 items-start transition-all hover:border-slate-700/50 hover:bg-slate-955/60">
        ...
        <div className="bg-slate-950/40 border border-slate-800/60 backdrop-blur-md p-5 rounded-2xl flex items-center gap-4 transition-all hover:bg-slate-955/50 max-w-xl relative z-20">
      ...
      {/* RIGHT HALF (40%): Floating card over solid dark blue/indigo gradient */}
      <div className="w-full md:w-2/5 lg:w-[42%] h-1/2 md:h-full bg-[#072a4a] bg-gradient-to-br from-[#0c4a6e] to-[#072a4a] flex items-center justify-center p-8 overflow-y-auto shrink-0 relative z-20">
        ...
        <div className="w-full max-w-md bg-white text-slate-800 rounded-[32px] shadow-2xl p-8 md:p-10 relative border border-slate-200/50 flex flex-col justify-between z-10 my-auto">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-650 font-medium"
                    >
      ...
      <div className="absolute bottom-4 right-6 lg:right-16 text-slate-400 text-[10px] font-medium z-30">
